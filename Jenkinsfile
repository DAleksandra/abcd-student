            ...
            steps {
                ...
                sh '''
                    ...
                    docker run --name zap --rm \
                        ...
                        -v /var/jenkins_home/workspace/DevSecOps/abcd-student/.zap/passive_scan.yaml:/zap/wrk:rw \
                        -t ghcr.io/zaproxy/zaproxy:stable bash -c \
                        "zap.sh -cmd -addonupdate; zap.sh -cmd -addoninstall communityScripts -addoninstall pscanrulesAlpha -addoninstall pscanrulesBeta -autorun /home/zap/wrk/passive_scan.yaml" 
                '''
            }
            post {
                always {
